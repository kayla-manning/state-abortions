...
```{r hospital_if_example}

# creating this table for EDA

tibble(Bins = c('12 weeks, 90 days',
                '14 weeks, 2nd trimester',
                'Viability, 24 weeks',
                '3rd trimester',
                'None'),
       Points = c(1, 0.75, 0.5, 0.25, 0)) %>% 
  kable(booktabs = TRUE,
        format = 'latex',
        caption = 'Assigning Points to Levels of Hospital Requirements')
