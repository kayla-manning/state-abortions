...
combined %>% 
  drop_na(prop_nonres) %>% 
  filter(prop_nonres %in% c(min(prop_nonres), max(prop_nonres)))
...
combined %>% 
  select(prop_nonres, prop_late, abortion_per_1k_births, 
...
combined %>% 
  select(prop_nonres, prop_late, abortion_per_1k_births, 
         abortion_per_100k_pop) %>% 
  filter_at(vars(prop_nonres, prop_late, abortion_per_1k_births, 
         abortion_per_100k_pop), 
         all_vars(!is.na(.))) %>% 
  cor() %>% 
