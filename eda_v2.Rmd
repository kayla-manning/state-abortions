...
p1 <- map_df %>% 
  ...
  labs(fill = '',
       title = 'Within-State Policy Scores') +
...
combined %>% 
  ...
  facet_wrap(~year)+
  coord_flip() +
  labs(title = 'Increasing Restrictiveness in National Landscape with Time',
       x = 'Policy Category',
       y = 'Count') +
  theme_thesis()
...
# mapping later-term abortion rates
 ...
 map_df %>% 
  ...
  coord_fixed(1.2) +
  facet_wrap(~year, nrow = 1) +
  labs(title = 'Later-term abortion rates',
       fill = 'Later-term abortions \nper 1000 live births') +
  theme_grey(base_family = 'Times') +
  theme(panel.background = element_blank(),
        axis.text = element_blank(),
        axis.line = element_blank(),
 ...
 map_df %>% 
  ...
  coord_fixed(1.2) +
  facet_wrap(~year, nrow = 1) +
  labs(title = 'Earlier-term abortion rates',
       fill = 'Earlier-term abortions \nper 1000 live births') +
  theme_grey(base_family = 'Times') +
  theme(panel.background = element_blank(),
        axis.text = element_blank(),
        axis.line = element_blank(),
...
sept2022 %>%
  ...
  scale_fill_manual(breaks = c('Expanded Access',
                    ...
                    values = c('lightblue',
                               ...
                               '#CC3333',
                               '#660000')) +
  labs(title = 'Post-Dobbs National Landscape',
       fill = '',
       caption = 'Source: Center for Reproductive Rights, as of September 19, 2022') +
  theme_grey(base_family = 'Times') +
  theme(panel.background = element_blank(),
        axis.text = element_blank(),
        axis.line = element_blank(),
