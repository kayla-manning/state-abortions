...
get_resid_map <- function(mod, year) {
  usa@data %>% 
    mutate(resids = residuals(mod),
...
p1 <- get_resid_map(rate_mod, 2012) +
  labs(fill = 'Overall Rate Residuals, 2012')
p2 <- get_resid_map(rate_nonres_mod, 2010) +
  labs(fill = 'Nonresident Rate Residuals, 2010')
p3 <- get_resid_map(rate_res_mod, 2012) +
  labs(fill = 'Resident Rate Residuals, 2012')
p4 <- get_resid_map(rate_early_mod, 2012) +
