...
# writing function to get qqplot
...
# hostile --> greater increase in count of later term
...
# model diagnostics (see
# https://stats.stackexchange.com/questions/70558/diagnostic-plots-for-count-regression
# for descriptions & more examples)

plot(fitted(test_late), residuals(test_late),
     xlim = c(0, 1000))
get_qq(test_late)
anova(test_late, test = 'Chisq')
deviance(test_late)/test_late$df.residual
...
summary(test_early)
plot(fitted(test_early), residuals(test_early),
     xlim = c(0, 50000))
plot(fitted(test_early), residuals(test_early))
get_qq(test_early)
