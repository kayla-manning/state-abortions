...
moran_outcomes %>% 
  ...
  row_spec(which(moran_outcomes$significant), bold = T, color = "black", background = rep("lightyellow"))
...
models <- list(rate_mod, rate_nonres_mod, rate_late_mod, rate_early_mod)
outcome_vars <- c('abortion rates',
                  'nonresident abortion rate',
                  'later-term abortion rate',
                  'earlier-term abortion rate')
plots <- list()
